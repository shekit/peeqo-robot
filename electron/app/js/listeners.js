...
const eyes = require('js/eyes')()
const localGif = require('js/local-gif')()
const remoteGif = require('js/remote-gif')()
const gifAction = require('js/common-gif-functions')()
const servo = require('js/servo')()
const led = require('js/led')()
const piControl = require('js/shutdown')()
const camera = require('js/camera')()
const hue = require('js/hue')()
const spotify = require('js/spotify')()
const productivity = require('js/productivity')()
const skills = require('js/skills')()
const sound = require('js/sounds')()
const personalize = require('js/personalize')()
